define(function () {
    ...
    EJS.Scanner = function (source, left, right) {
        ...
        this.SplitRegexp = left == '[' ? /(\[%%)|(%%\])|(\[%=)|(\[%#)|(\[%)|(%\]\n)|(%\])|(\n)/ : new RegExp('(' +
            this.double_left + ')|(%%' + this.double_right + ')|(' + this.left_equal + ')|(' + this.left_comment +
    ...
    EJS.Compiler.prototype = {
        compile: function (options, name) {
            ...
            var to_be_evaled = '/*' + name +
                '*/this.process = function(_CONTEXT,_VIEW) { try { with(_VIEW) { with (_CONTEXT) {' + this.out +
