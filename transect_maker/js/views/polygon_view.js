define(["baseView", "pointView", "lineView", "point", "points", "line", "lines", "polyK"], function (BaseView,
    PointView, LineView, Point, Points, Line, Lines, PolyK) {
    ...
    PolygonView.prototype.renderTooltip = function () {
        $(this.element.node).qtip({
            content: {
                text: this.polygon.get('name') + "【" + this.polygon.get('patternName') + "】<br>" + (this.polygon
                    .get('description') || "No description yet!")
            },
            position: {
