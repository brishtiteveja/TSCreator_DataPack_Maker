...
define(["baseView"], function(BaseView) {
	...
	DataExportView.prototype.template = new EJS({url: '/lithology_column_maker/ejs/data_export_panel.ejs'});
	DataExportView.prototype.lithologyColumnDataTemplate = new EJS({url: '/lithology_column_maker/ejs/lithology_column_data.ejs'});
	...
	DataExportView.prototype.render = function() {
		...
		this.$el.html(this.template.render({lithologyColumns: this.lithologyColumns.toJSON()}));
